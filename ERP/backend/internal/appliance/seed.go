...
type defaultDataDictionarySeed struct {
	Type  string
	Code  string
	Label string
}

var defaultDataDictionarySeeds = []defaultDataDictionarySeed{
	{"product_line", "asphalt", "沥青混合料"},
	{"product_line", "modified_asphalt", "改性沥青混合料"},
	{"product_line", "stabilized_soil", "水稳混合料"},
	{"product_line", "mortar_wet", "湿拌砂浆"},
	{"product_line", "ready_mixed_concrete", "商品混凝土"},
	{"product_line", "aggregate", "砂石骨料"},
	{"product_line", "recycled_material", "再生材料"},
	{"dispatch_status", "draft", "草稿"},
	{"dispatch_status", "pending", "待调度"},
	{"dispatch_status", "assigned", "已派车"},
	{"dispatch_status", "waiting_load", "等待装料"},
	{"dispatch_status", "loading", "装料中"},
	{"dispatch_status", "loaded", "已装料"},
	{"dispatch_status", "in_transit", "运输中"},
	{"dispatch_status", "arrived", "已到场"},
	{"dispatch_status", "unloading", "卸料中"},
	{"dispatch_status", "signed", "已签收"},
	{"dispatch_status", "completed", "已完成"},
	{"dispatch_status", "cancelled", "已取消"},
	{"dispatch_status", "abnormal", "异常"},
	{"ticket_type", "product_out", "成品出厂"},
	{"ticket_type", "raw_material_in", "原料入厂"},
	{"ticket_type", "transfer_in", "调拨入库"},
	{"ticket_type", "transfer_out", "调拨出库"},
	{"ticket_type", "return_material", "退料入库"},
	{"ticket_type", "adjustment", "库存调整"},
	{"invoice_type", "blue_vat_special", "蓝字增值税专用发票"},
	{"invoice_type", "blue_vat_normal", "蓝字增值税普通发票"},
	{"invoice_type", "blue_e_invoice", "蓝字电子普通发票"},
	{"invoice_type", "blue_e_special", "蓝字电子专用发票"},
	{"invoice_type", "red_vat_special", "红字增值税专用发票"},
	{"invoice_type", "red_vat_normal", "红字增值税普通发票"},
	{"invoice_type", "red_e_invoice", "红字电子普通发票"},
	{"invoice_type", "red_e_special", "红字电子专用发票"},
	{"quality_status", "pending", "待检"},
	{"quality_status", "sampling", "取样中"},
	{"quality_status", "testing", "检测中"},
	{"quality_status", "passed", "合格"},
	{"quality_status", "failed", "不合格"},
	{"quality_status", "blocked", "冻结"},
	{"quality_result", "pending", "待判定"},
	{"quality_result", "passed", "合格"},
	{"quality_result", "failed", "不合格"},
	{"quality_result", "retest", "复检"},
	{"quality_result", "waived", "让步接收"},
	{"yard_type", "aggregate_yard", "骨料堆场"},
	{"yard_type", "powder_yard", "粉料堆场"},
	{"yard_type", "recycle_yard", "回收料堆场"},
	{"yard_type", "finished_product_yard", "成品堆场"},
	{"yard_type", "raw_material_yard", "原料堆场"},
	{"buffer_type", "aggregate_bin", "骨料筒仓"},
	{"buffer_type", "cold_feed_bin", "冷料仓"},
	{"buffer_type", "powder_silo", "粉料筒仓"},
	{"buffer_type", "asphalt_tank", "沥青罐"},
	{"buffer_type", "admixture_tank", "添加剂罐"},
	{"buffer_type", "finished_bin", "成品暂存仓"},
	{"buffer_type", "return_bin", "回料筒仓"},
	{"vehicle_type", "搅拌车", "搅拌车"},
	{"vehicle_type", "自卸车", "自卸车"},
	{"vehicle_type", "罐车", "罐车"},
	{"vehicle_type", "沥青运输车", "沥青运输车"},
	{"vehicle_type", "粉料罐车", "粉料罐车"},
	{"vehicle_type", "骨料运输车", "骨料运输车"},
	{"vehicle_type", "平板车", "平板车"},
	{"vehicle_type", "泵车", "泵车"},
	{"plant_status", "active", "启用"},
	{"plant_status", "running", "运行中"},
	{"plant_status", "standby", "待机"},
	{"plant_status", "maintenance", "检修中"},
	{"plant_status", "stopped", "停机"},
	{"plant_status", "disabled", "禁用"},
	{"resource_status", "active", "启用"},
	{"resource_status", "running", "使用中"},
	{"resource_status", "idle", "空闲"},
	{"resource_status", "cleaning", "清理中"},
	{"resource_status", "maintenance", "维护中"},
	{"resource_status", "disabled", "禁用"},
	{"resource_status", "archived", "归档"},
	{"shift_type", "早班", "早班"},
	{"shift_type", "中班", "中班"},
	{"shift_type", "晚班", "晚班"},
	{"shift_type", "夜班", "夜班"},
	{"shift_type", "全天", "全天"},
	{"delivery_channel", "qr", "二维码"},
	{"delivery_channel", "sms", "短信"},
	{"delivery_channel", "wechat", "微信"},
	{"delivery_channel", "driver_app", "司机 App"},
	{"delivery_channel", "customer_portal", "客户门户"},
	{"delivery_channel", "manual", "人工签收"},
	{"payment_method", "bank", "银行转账"},
	{"payment_method", "cash", "现金"},
	{"payment_method", "bill", "票据"},
	{"payment_method", "acceptance", "承兑汇票"},
	{"payment_method", "wechat", "微信支付"},
	{"payment_method", "alipay", "支付宝"},
	{"payment_method", "digital_cny", "数字人民币"},
	{"payment_method", "offset", "往来抵扣"},
	{"org_company_level", "headquarters", "总部"},
	{"org_company_level", "regional", "区域公司"},
	{"org_company_level", "subsidiary", "子公司"},
	{"org_company_level", "branch", "分公司"},
	{"org_company_level", "project_company", "项目公司"},
	{"org_company_level", "joint_venture", "合资公司"},
	{"data_scope", "group", "集团"},
	{"data_scope", "company", "公司"},
	{"data_scope", "department", "部门"},
	{"data_scope", "site", "站点"},
	{"data_scope", "customer", "客户"},
	{"data_scope", "driver", "司机"},
	{"data_scope", "device", "设备"},
	{"data_scope", "self", "本人"},
	{"config_status", "draft", "草稿"},
	{"config_status", "active", "启用"},
	{"config_status", "disabled", "禁用"},
	{"config_status", "archived", "归档"},
	{"account_status", "pending", "待启用"},
	{"account_status", "active", "启用"},
	{"account_status", "locked", "锁定"},
	{"account_status", "disabled", "禁用"},
	{"laboratory_test_type", "marshall_stability", "马歇尔稳定度"},
	{"laboratory_test_type", "asphalt_content", "油石比"},
	{"laboratory_test_type", "gradation", "级配筛分"},
	{"laboratory_test_type", "density", "密度"},
	{"laboratory_test_type", "moisture", "含水率"},
	{"laboratory_test_type", "slump", "坍落度"},
	{"laboratory_test_type", "compressive_strength", "抗压强度"},
	{"laboratory_test_type", "durability", "耐久性"},
	{"laboratory_test_type", "raw_material", "原料复检"},
	{"laboratory_test_type", "temperature", "温度检测"},
	{"severity_level", "low", "低"},
	{"severity_level", "medium", "中"},
	{"severity_level", "high", "高"},
	{"severity_level", "critical", "严重"},
	{"sample_source_type", "manual", "手工登记"},
	{"sample_source_type", "production_batch", "生产批次"},
	{"sample_source_type", "raw_inspection", "原材验收"},
	{"sample_source_type", "quality_inspection", "质检抽样"},
	{"sample_source_type", "weighbridge_ticket", "过磅记录"},
	{"sample_source_type", "customer_complaint", "客户投诉"},
	{"sample_source_type", "site_sampling", "现场抽样"},
	{"settlement_status", "draft", "草稿"},
	{"settlement_status", "unpaid", "未结算"},
	{"settlement_status", "partial", "部分结算"},
	{"settlement_status", "settled", "已结算"},
	{"settlement_status", "overdue", "已逾期"},
	{"settlement_status", "written_off", "已核销"},
	{"settlement_status", "cancelled", "已取消"},
}

func defaultDataDictionaries() []DataDictionary {
	items := make([]DataDictionary, 0, len(defaultDataDictionarySeeds))
	sortByType := map[string]int{}
	for index, seed := range defaultDataDictionarySeeds {
		sortByType[seed.Type]++
		items = append(items, DataDictionary{
			ID:     int64(index + 1),
			Type:   seed.Type,
			Code:   seed.Code,
			Label:  seed.Label,
			Sort:   sortByType[seed.Type],
			Status: "active",
		})
	}
	return items
...
func SeedData() AppData {
	adminSalt, adminHash, adminStatus := seedUserCredential("admin")
	dispatchSalt, dispatchHash, dispatchStatus := seedUserCredential("dispatcher")
	driverSalt, driverHash, driverStatus := seedUserCredential("driver")
	customerSalt, customerHash, customerStatus := seedUserCredential("customer")
	qualitySalt, qualityHash, qualityStatus := seedUserCredential("quality")
	companySalt, companyHash, companyStatus := seedUserCredential("east_manager")

	data := AppData{
		SchemaVersion: 2,
		Next: map[string]int64{
			"user": 6, "role": 7, "company": 2, "site": 3, "customer": 2, "project": 2,
			"productInstance": 2, "systemAlert": 2, "renewalTask": 2, "renewalQuote": 1, "renewalContract": 1, "renewalPayment": 1, "renewalApproval": 1, "renewalInvoice": 1, "renewalESign": 1, "renewalIntegration": 3, "renewalSyncRecord": 0, "probeReport": 2, "telemetryEvent": 2, "monitoringIntegration": 1, "productAlertRule": 2, "monitoringEvent": 1, "alertPolicy": 2, "alertChannel": 5, "alertNotification": 1, "updateRollout": 1, "updateRolloutItem": 2, "updateExecution": 1, "updateExecutionStep": 7, "systemUpdateTask": 1, "systemUpdateTaskLog": 2,
			"product": 6, "material": 5, "supplier": 2, "vehicle": 4, "driver": 4,
			"contract": 1, "contractAttachment": 1, "order": 2, "orderLine": 2, "productionPlan": 1, "mixDesign": 2, "mixPlantProfile": 1, "mixTrial": 1,
			...
			"department": 3, "plant": 2, "plantBuffer": 2, "plantBufferFlow": 2, "stockYard": 1, "stockYardPile": 2, "stockYardFlow": 2, "warehouse": 2, "silo": 6, "contact": 2, "customerBlacklist": 0, "customerProfile": 2, "customerComplaint": 1,
			"pricePolicy": 5, "taxRate": 2, "carrier": 2, "device": 5, "vehicleDevice": 5,
			...
			"invoice": 1, "redLetter": 0, "taxSubmission": 0, "receivable": 1, "moneyReceipt": 1, "paymentPlan": 1, "collectionTask": 0, "collectionTemplate": 3, "collectionDispatch": 0, "supplierStatement": 1,
			...
			"approvalFlow": 5, "approvalTask": 0, "workflowDefinition": 5, "workflowInstance": 0, "workflowTask": 0, "dict": int64(len(defaultDataDictionarySeeds)), "deviceCredential": 7, "securityPolicy": 6, "fieldPolicy": 8,
		...
		Modules: []Module{
			...
			{"master-data", "基础资料中心", "运营中心", "公司、站点、生产线、客户、产品、车辆、司机、物料", true, true, "1.0.0"},
			...
			{"quality", "实验室管理", "生产到发货", "基础配比、生产线配比、试配、原料检验、试样、仪器校准和异常闭环", true, true, "1.0.0"},
			{"inventory", "堆场管理", "物料堆场", "堆场、堆位、库存台账、批次与预警", true, true, "1.0.0"},
			{"weighbridge", "过磅记录", "生产到发货", "过磅记录、抓拍、作废和结算锁定", true, true, "1.0.0"},
		...
		Roles: []Role{
			...
			{6, "quality", "实验室质检员", []string{"bootstrap:read", "dashboard:read", "production:read", "quality:*", "procurement:read", "approval:read", "approval:write"}, "site"},
			{7, "company-manager", "分公司经理", []string{"bootstrap:read", "dashboard:read", "org:*", "master:*", "order:read", "production:read", "dispatch:read", "vehicle:read", "ticket:read", "delivery:read", "statement:read", "finance:read", "report:read", "approval:*"}, "company"},
		},
		Users: []User{
			{ID: 1, CompanyID: 1, Username: "admin", DisplayName: "超级管理员", RoleCode: "boss", PasswordHash: adminHash, PasswordSalt: adminSalt, Status: adminStatus},
			{ID: 2, CompanyID: 1, SiteID: 1, Username: "dispatcher", DisplayName: "南山站调度", RoleCode: "dispatcher", PasswordHash: dispatchHash, PasswordSalt: dispatchSalt, Status: dispatchStatus},
			{ID: 3, CompanyID: 1, SiteID: 1, DriverID: 1, Username: "driver", DisplayName: "司机李师傅", RoleCode: "driver", PasswordHash: driverHash, PasswordSalt: driverSalt, Status: driverStatus},
			{ID: 4, CompanyID: 1, CustomerID: 1, Username: "customer", DisplayName: "客户王经理", RoleCode: "customer", PasswordHash: customerHash, PasswordSalt: customerSalt, Status: customerStatus},
			{ID: 5, CompanyID: 1, SiteID: 1, Username: "quality", DisplayName: "实验室质检员", RoleCode: "quality", PasswordHash: qualityHash, PasswordSalt: qualitySalt, Status: qualityStatus},
			{ID: 6, CompanyID: 2, SiteID: 3, Username: "east_manager", DisplayName: "华东区域经理", RoleCode: "company-manager", PasswordHash: companyHash, PasswordSalt: companySalt, Status: companyStatus},
		},
		SCIMProviders: []SCIMProvider{
			{
				ID: 1, Name: "企业 SCIM 接入", Code: "enterprise-scim",
				CompanyID: 1, SiteID: 0, DefaultRoleCode: "customer", Status: "disabled",
		...
		ProductInstances: []ProductInstance{
			{
				...
				Endpoint: "https://cbmp.wanqu.example", Status: "online", ProbeToken: "probe-01c587c44246281c98b7bbc0", ProbeEnabled: true,
			...
			},
			{
				...
				Endpoint: "https://cbmp.hn.example", Status: "degraded", ProbeToken: "probe-885517dddd668955ad0dd7ab", ProbeEnabled: true,
		...
		GroupProfile: GroupProfile{Name: "湾区建材集团", Code: "WQBM-GROUP", Edition: "集团版", HeadquartersCompanyID: 1, OperatingMode: "集团总部统管", DataArchitecture: "group-company-department"},
		Companies: []Company{
			{ID: 1, Name: "湾区建材集团有限公司", Code: "WQBM", Level: "headquarters", Region: "粤港澳大湾区", Status: "active"},
			{ID: 2, Name: "华东材料区域公司", Code: "EAST", ParentID: 1, Level: "regional", Region: "华东", Status: "active"},
		},
		Sites: []Site{
			{ID: 1, CompanyID: 1, Name: "南山沥青站", Code: "NS-ASP", Address: "深圳市南山区科苑路 88 号", Longitude: 113.9345, Latitude: 22.5431, FenceRadius: 450, Status: "active"},
			{ID: 2, CompanyID: 1, Name: "宝安综合材料站", Code: "BA-MIX", Address: "深圳市宝安区机场南路 21 号", Longitude: 113.8293, Latitude: 22.6392, FenceRadius: 500, Status: "active"},
			{ID: 3, CompanyID: 2, Name: "杭州湾材料站", Code: "HZB-MAT", Address: "杭州市钱塘区江东一路 16 号", Longitude: 120.4812, Latitude: 30.2866, FenceRadius: 300, Status: "active"},
		},
		Departments: []Department{
			{1, 1, "集团运营中心", "OPS", 0, "active"},
			{2, 1, "南山站生产部", "NS-PROD", 1, "active"},
			{3, 1, "财务结算部", "FIN", 1, "active"},
			{4, 2, "华东运营部", "EAST-OPS", 0, "active"},
			{5, 2, "杭州湾站生产部", "HZB-PROD", 4, "active"},
		},
		Plants: []Plant{
			{ID: 1, SiteID: 1, Name: "南山 240 沥青线", Code: "NS-AMP240", Capacity: "240t/h", Status: "running"},
			{ID: 2, SiteID: 2, Name: "宝安综合材料线", Code: "BA-MIX-01", Capacity: "240t/h", Status: "running"},
		},
		PlantBufferLocations: []PlantBufferLocation{
			{ID: 1, SiteID: 1, PlantID: 1, PlantCode: "NS-AMP240", Code: "NS-AMP240-AGG-01", Name: "1#机制砂仓", Type: "aggregate_bin", MaterialID: 3, AllowedMaterialIDs: []int64{3}, Capacity: 160, Unit: "t", CurrentQty: 82.5, WarningQty: 25, MoistureRate: 4.2, QualityStatus: "passed", Status: "active", GatewayDeviceNo: "PLANT-NS-AMP240", GatewayChannel: "industrial-control-gateway", GatewayProtocol: "buffer-json", LastReportedAt: "2026-06-18 10:20:00", LastFrameStatus: "accepted", CreatedAt: "2026-06-18 08:00:00", UpdatedAt: "2026-06-18 10:20:00"},
			{ID: 2, SiteID: 1, PlantID: 1, PlantCode: "NS-AMP240", Code: "NS-AMP240-AGG-02", Name: "2#碎石仓", Type: "aggregate_bin", MaterialID: 4, AllowedMaterialIDs: []int64{4}, Capacity: 180, Unit: "t", CurrentQty: 126.8, WarningQty: 30, MoistureRate: 1.1, QualityStatus: "passed", Status: "active", GatewayDeviceNo: "PLANT-NS-AMP240", GatewayChannel: "industrial-control-gateway", GatewayProtocol: "buffer-json", LastReportedAt: "2026-06-18 10:20:00", LastFrameStatus: "accepted", CreatedAt: "2026-06-18 08:00:00", UpdatedAt: "2026-06-18 10:20:00"},
		},
		StockYards: []StockYard{
			{ID: 1, SiteID: 1, Code: "NS-YARD-AGG", Name: "南山骨料堆场", Type: "aggregate_yard", Area: "北侧堆场", Capacity: 3000, Unit: "t", Status: "active", GatewayDeviceNo: "YARD-NS-AGG", LastReportedAt: "2026-06-18 10:10:00", CreatedAt: "2026-06-18 08:00:00", UpdatedAt: "2026-06-18 10:10:00"},
		},
		StockYardPiles: []StockYardPile{
			{ID: 1, SiteID: 1, YardID: 1, YardCode: "NS-YARD-AGG", Code: "NS-YARD-SAND-01", Name: "机制砂 1#料堆", MaterialID: 3, SupplierID: 1, BatchNo: "SAND-20260617-A", Capacity: 1200, Unit: "t", CurrentQty: 540, WarningQty: 120, MoistureRate: 4.6, QualityStatus: "passed", Status: "active", GatewayDeviceNo: "YARD-NS-AGG", GatewayChannel: "industrial-control-gateway", GatewayProtocol: "yard-json", LastReportedAt: "2026-06-18 10:10:00", LastFrameStatus: "accepted", CreatedAt: "2026-06-18 08:00:00", UpdatedAt: "2026-06-18 10:10:00"},
			{ID: 2, SiteID: 1, YardID: 1, YardCode: "NS-YARD-AGG", Code: "NS-YARD-STONE-01", Name: "碎石 1#料堆", MaterialID: 4, SupplierID: 2, BatchNo: "STONE-20260617-A", Capacity: 1500, Unit: "t", CurrentQty: 860, WarningQty: 150, MoistureRate: 1.2, QualityStatus: "passed", Status: "active", GatewayDeviceNo: "YARD-NS-AGG", GatewayChannel: "industrial-control-gateway", GatewayProtocol: "yard-json", LastReportedAt: "2026-06-18 10:10:00", LastFrameStatus: "accepted", CreatedAt: "2026-06-18 08:00:00", UpdatedAt: "2026-06-18 10:10:00"},
		},
		...
		Silos: []Silo{
			{1, 1, 1, "沥青罐 1", "SILO-BITUMEN-01", 1800, 1260, "active"},
			{2, 1, 3, "机制砂仓 1", "SAND-01", 2500, 840, "warning"},
			{3, 1, 4, "碎石仓 1", "STONE-01", 3000, 2380, "active"},
			{4, 2, 5, "添加剂罐 1", "ADDITIVE-01", 50, 18, "warning"},
			{5, 1, 2, "矿粉罐 1", "MINERAL-POWDER-01", 900, 420, "active"},
			{6, 1, 5, "添加剂罐 2", "ADDITIVE-NS-01", 60, 36, "active"},
		},
		Customers: []Customer{
		...
		PricePolicies: []PricePolicy{
			...
			{ID: 5, CustomerID: 1, ProjectID: 1, ProductID: 2, CustomerGrade: "A", Region: "南山", MinQuantity: 30, FloorPrice: 575, SalePrice: 625, PromotionName: "AC-20 大吨位立减", PromotionType: "fixed", PromotionValue: 20, Priority: 15, TaxRateID: 1, EffectiveFrom: "2026-06-01", EffectiveTo: "2027-05-31", Status: "active"},
		},
		Suppliers: []Supplier{
			{1, "粤港砂石供应链", "黄总", "13700020001", "active"},
			{2, "华南沥青供应链", "刘经理", "13700020002", "active"},
		},
		Carriers: []Carrier{
		...
		Products: []Product{
			{1, "asphalt", "细粒式沥青混合料", "AC-13", "t", 520, 365, true, "active"},
			{2, "asphalt", "中粒式沥青混合料", "AC-20", "t", 610, 430, true, "active"},
			{3, "mortar_wet", "湿拌砂浆", "M10", "t", 280, 205, true, "active"},
			{4, "modified_asphalt", "改性沥青混合料", "SMA-13", "t", 720, 540, true, "active"},
			{5, "stabilized_soil", "水稳混合料", "5% 水泥剂量", "t", 165, 118, true, "active"},
			{6, "aggregate", "机制砂", "0-5mm", "t", 96, 66, false, "active"},
		},
		Materials: []Material{
			{1, "道路石油沥青", "70#", "t", 800, "active"},
			{2, "矿粉", "0-0.075mm", "t", 300, "active"},
			{3, "机制砂", "0-5mm", "t", 1200, "active"},
			{4, "碎石", "5-25mm", "t", 1600, "active"},
			{5, "抗剥落剂", "液体", "t", 25, "active"},
		},
		Drivers: []Driver{
		...
		Vehicles: []Vehicle{
			{1, "V001", "粤B12345", "沥青运输车", "20t", "自有车队", 1, 1, "online", "in_transit", "2027-09-12", "active"},
			{2, "V002", "粤B22336", "沥青运输车", "20t", "自有车队", 1, 2, "online", "waiting_load", "2027-10-02", "active"},
			{3, "V003", "粤B77889", "粉料罐车", "32t", "外协车队", 2, 3, "offline", "idle", "2026-10-20", "active"},
			{4, "V004", "粤B66778", "自卸车", "28t", "外协车队", 2, 4, "online", "idle", "2028-01-18", "active"},
		},
		VehicleDevices: []VehicleDevice{
			...
			{5, 0, "PLANT-NS-AMP240", "opc", "沥青站控制系统", "online", "2026-06-18 10:20:00"},
		},
		DeviceCredentials: []DeviceCredential{
			{1, "GPS1000001", "", []string{"location:report"}, "disabled", ""},
			{2, "GPS1000002", "", []string{"location:report"}, "disabled", ""},
			{3, "GPS1000003", "", []string{"location:report"}, "disabled", ""},
			{4, "APP1000004", "", []string{"location:report"}, "disabled", ""},
			{5, "NS-SCALE-01", "", []string{"scale:report"}, "disabled", ""},
			{6, "PLANT-NS-AMP240", "", []string{"plant:report"}, "disabled", ""},
			{7, "GPS-FORWARDER", "", []string{"location:report"}, "disabled", ""},
		},
		...
		Contracts: []Contract{
			{
				...
				Name: "科技园二期沥青供应合同", ValidFrom: "2026-06-01", ValidTo: "2027-05-31",
				...
				Items: []ContractItem{{1, "t", 10000, 520}, {2, "t", 3000, 610}},
			},
		},
		ContractAttachments: []ContractAttachment{
			{1, 1, 1, "科技园二期供应合同.pdf", "contract_pdf", "data:application/pdf;base64,JVBERi0xLjQK", "sha256:e5c62df5dab5c87b6a015ef3d43597074d1eec433b15f51aec63b8582d0e4ab4", "active", "system", "2026-06-18 09:10:00"},
		},
		Orders: []SalesOrder{
			{
				ID: 1, OrderNo: "SO202606180001", CustomerID: 1, ProjectID: 1, ProductID: 1, SiteID: 1,
				ProductLine: "asphalt", PlanQuantity: 180, Unit: "t", UnitPrice: 520, TotalAmount: 93600,
				Lines:    []SalesOrderLine{{ID: 1, Seq: 1, ProductID: 1, ProductLine: "asphalt", ProductName: "AC-13 沥青混合料", StrengthGrade: "AC-13", Slump: "油石比 5.1%", PouringPart: "主车道下面层", Quantity: 180, Unit: "t", UnitPrice: 520, FloorPrice: 500, TaxRate: 0.13, Amount: 93600, PriceSource: "seed"}},
				PlanTime: "2026-06-18 14:00:00", ReceiveAddress: "深圳市南山区高新南一道", Contact: "王经理", Phone: "13800010001",
				SettlementMode: "月结", TransportMode: "自有车队", StrengthGrade: "AC-13", Slump: "油石比 5.1%", PouringPart: "主车道下面层", PumpMode: "摊铺机",
			...
			},
			{
				...
				ProductLine: "asphalt", PlanQuantity: 120, Unit: "t", UnitPrice: 610, TotalAmount: 73200,
				Lines:    []SalesOrderLine{{ID: 2, Seq: 1, ProductID: 2, ProductLine: "asphalt", ProductName: "AC-20 沥青混合料", StrengthGrade: "AC-20", Slump: "油石比 4.8%", PouringPart: "匝道面层", Quantity: 120, Unit: "t", UnitPrice: 610, FloorPrice: 590, TaxRate: 0.13, Amount: 73200, PriceSource: "seed"}},
				PlanTime: "2026-06-19 08:30:00", ReceiveAddress: "深圳市南山区高新南一道", Contact: "王经理", Phone: "13800010001",
				SettlementMode: "月结", TransportMode: "自有车队", StrengthGrade: "AC-20", Slump: "油石比 4.8%", PouringPart: "匝道面层", PumpMode: "摊铺机",
				Status: "approved", CreatedAt: "2026-06-18 09:25:00",
			},
		},
		ProductionPlans: []ProductionPlan{
			{
				ID: 1, PlanNo: "PP202606180001", OrderID: 1, SiteID: 1, PlantID: 1, PlantCode: "NS-AMP240", ProductID: 1, MixDesignID: 1, MixProfileID: 1,
				PlanQuantity: 180, ProducedQty: 72, PlanDate: "2026-06-18", Shift: "白班",
				CapacityStatus: "ok", InventoryStatus: "ok", RecipeStatus: "ok", Status: "producing",
				CreatedAt: "2026-06-18 09:40:00", UpdatedAt: "2026-06-18 10:20:00",
			},
		},
		MixDesigns: []MixDesign{
			{
				ID: 1, ProductID: 1, SiteID: 1, Code: "MD-AC13", Version: "v3", StrengthGrade: "AC-13", Slump: "油石比 5.1%",
				Scope: "主车道下面层沥青混合料", Status: "approved", IsCurrent: true, EffectiveFrom: "2026-01-01", EffectiveTo: "2026-12-31",
				...
				Materials: []MixDesignMaterial{
					{MaterialID: 1, Dosage: 52, Unit: "kg/t"},
					{MaterialID: 2, Dosage: 48, Unit: "kg/t"},
					{MaterialID: 3, Dosage: 380, Unit: "kg/t"},
					{MaterialID: 4, Dosage: 560, Unit: "kg/t"},
					{MaterialID: 5, Dosage: 7.5, Unit: "kg/t"},
				},
			},
			{
				ID: 2, ProductID: 2, SiteID: 1, Code: "MD-AC20", Version: "v2", StrengthGrade: "AC-20", Slump: "油石比 4.8%",
				Scope: "匝道面层沥青混合料", Status: "approved", IsCurrent: true, EffectiveFrom: "2026-01-01", EffectiveTo: "2026-12-31",
				...
				Materials: []MixDesignMaterial{
					{MaterialID: 1, Dosage: 50, Unit: "kg/t"},
					{MaterialID: 2, Dosage: 55, Unit: "kg/t"},
					{MaterialID: 3, Dosage: 360, Unit: "kg/t"},
					{MaterialID: 4, Dosage: 575, Unit: "kg/t"},
					{MaterialID: 5, Dosage: 8.2, Unit: "kg/t"},
				},
			},
		},
		MixDesignPlantProfiles: []MixDesignPlantProfile{
			{
				ID: 1, MixDesignID: 1, ProductID: 1, SiteID: 1, PlantID: 1, PlantCode: "NS-AMP240",
				Code: "MD-AC13-NS-AMP240", Version: "v3-line-a", Scope: "1号线机制砂含水微调", Status: "approved", IsCurrent: true,
				EffectiveFrom: "2026-06-01", EffectiveTo: "2026-12-31", ApprovedBy: "实验室主任", ApprovedAt: "2026-06-01 08:40:00",
				CreatedBy: "system", CreatedAt: "2026-06-01 08:20:00", UpdatedAt: "2026-06-01 08:40:00",
				Materials: []MixDesignPlantProfileMaterial{
					{MaterialID: 3, Adjustment: -8, Unit: "kg/t", BufferID: 1, BufferCode: "NS-AMP240-AGG-01", Remark: "机制砂偏细，降低用量"},
					{MaterialID: 5, Adjustment: 0.3, Unit: "kg/t", Remark: "外加剂小幅补偿"},
				},
				Remark: "生产线试生产稳定后放行",
			},
		},
		MixDesignTrialRuns: []MixDesignTrialRun{
			{ID: 1, TrialNo: "MTR202606180001", MixDesignID: 1, ProductID: 1, SiteID: 1, TargetStrength: "AC-13", Slump: "油石比 5.1%", Water: 0, SandRate: 42, AdmixtureRate: 1.2, Strength7d: 8.2, Strength28d: 9.1, Result: "passed", Conclusion: "油石比和稳定度满足生产放行", Tester: "实验室质检员", TestedAt: "2026-06-18 08:30:00", CreatedAt: "2026-06-18 08:20:00", Remark: "配比 v3 月度复核"},
		},
		ProductionTasks: []ProductionTask{
			{
				ID: 1, TaskNo: "PT202606180001", PlanID: 1, OrderID: 1, SiteID: 1, PlantID: 1, PlantCode: "NS-AMP240",
				ProductID: 1, MixDesignID: 1, MixProfileID: 1, PlanQty: 180, ProducedQty: 72, Status: "running",
				StartedAt: "2026-06-18 10:00:00", CreatedAt: "2026-06-18 09:50:00", UpdatedAt: "2026-06-18 10:20:00",
			},
		},
		ProductionBatches: []ProductionBatch{
			{
				ID: 1, BatchNo: "PB202606180001", TaskID: 1, PlanID: 1, OrderID: 1, SiteID: 1, PlantID: 1,
				ProductID: 1, MixDesignID: 1, MixProfileID: 1, Quantity: 72, PlantCode: "NS-AMP240", Operator: "生产员-陈工",
				QualityStatus: "passed", Status: "released", StartedAt: "2026-06-18 10:00:00", CompletedAt: "2026-06-18 10:20:00",
			},
		},
		...
		LaboratorySamples: []LaboratorySample{
			{ID: 1, SampleNo: "LS202606180001", SourceType: "manual", SiteID: 1, ProductID: 1, MixDesignID: 1, SampleType: "mix_design_trial", Status: "completed", Result: "passed", PlannedTestAt: "2026-06-18", CollectedAt: "2026-06-18 08:15:00", CreatedBy: "实验室质检员", Remark: "AC-13 配比月度复核样"},
		},
		LaboratoryTests: []LaboratoryTestRecord{
			{ID: 1, TestNo: "LT202606180001", SampleID: 1, EquipmentID: 1, SiteID: 1, TestType: "marshall_stability", Metric: "stability", Value: 9.1, Unit: "kN", Result: "passed", Status: "reviewed", Tester: "实验室质检员", TestedAt: "2026-06-18 08:30:00", Reviewer: "实验室主任", ReviewedAt: "2026-06-18 08:45:00", Remark: "满足 AC-13 配比复核要求"},
		},
		LaboratoryEquipment: []LaboratoryEquipment{
			{ID: 1, EquipmentNo: "EQ-LAB-001", Name: "马歇尔稳定度仪", SiteID: 1, Model: "LWD-3", SerialNo: "NS-LAB-MARSHALL-01", Status: "active", CalibrationCycleDays: 180, LastCalibrationAt: "2026-06-01", NextCalibrationAt: "2026-11-28", CreatedAt: "2026-01-01 08:00:00", Remark: "沥青混合料稳定度"},
			{ID: 2, EquipmentNo: "EQ-LAB-002", Name: "油石比抽提仪", SiteID: 1, Model: "LLC-30", SerialNo: "NS-LAB-ASPHALT-01", Status: "active", CalibrationCycleDays: 365, LastCalibrationAt: "2026-03-01", NextCalibrationAt: "2027-03-01", CreatedAt: "2026-01-01 08:10:00", Remark: "出厂油石比检测"},
		},
		...
		QualityExceptions: []QualityException{
			{ID: 1, ExceptionNo: "QE202606180001", SourceType: "transport", SourceID: 2, SiteID: 1, Severity: "medium", Title: "运输时长接近温控风险阈值", Description: "DO202606180002 距离签收超时预警阈值较近，实验室持续关注油石比复测。", Status: "open", Responsible: "南山站调度", CreatedAt: "2026-06-18 11:40:00"},
		},
		InventoryFlows: []InventoryFlow{
			{1, "IF202606180001", 1, 3, "raw_material_receipt", 1, "in", 31.4, 840, "原料入厂过磅入库", "2026-06-18 09:00:00"},
			{2, "IF202606180002", 1, 1, "production_batch", 1, "out", 3.74, 1260, "AC-13 理论扣减", "2026-06-18 10:20:00"},
			{3, "IF202606180003", 1, 4, "production_batch", 1, "out", 40.32, 2380, "AC-13 理论扣减", "2026-06-18 10:20:00"},
		},
		PlantBufferFlows: []PlantBufferFlow{
			{ID: 1, FlowNo: "PBF202606180001", SiteID: 1, PlantID: 1, BufferID: 1, BufferCode: "NS-AMP240-AGG-01", MaterialID: 3, SourceType: "buffer_level_report", Direction: "level_report", Quantity: 82.5, BalanceQty: 82.5, Unit: "t", MoistureRate: 4.2, QualityStatus: "passed", Actor: "device:PLANT-NS-AMP240", Remark: "网关料位上报", CreatedAt: "2026-06-18 10:20:00"},
			{ID: 2, FlowNo: "PBF202606180002", SiteID: 1, PlantID: 1, BufferID: 2, BufferCode: "NS-AMP240-AGG-02", MaterialID: 4, SourceType: "buffer_level_report", Direction: "level_report", Quantity: 126.8, BalanceQty: 126.8, Unit: "t", MoistureRate: 1.1, QualityStatus: "passed", Actor: "device:PLANT-NS-AMP240", Remark: "网关料位上报", CreatedAt: "2026-06-18 10:20:00"},
		},
		StockYardFlows: []StockYardFlow{
			{ID: 1, FlowNo: "SYF202606180001", SiteID: 1, YardID: 1, PileID: 1, PileCode: "NS-YARD-SAND-01", MaterialID: 3, SourceType: "yard_level_report", Direction: "level_report", Quantity: 540, BalanceQty: 540, Unit: "t", MoistureRate: 4.6, QualityStatus: "passed", Actor: "device:YARD-NS-AGG", Remark: "网关堆场料位上报", CreatedAt: "2026-06-18 10:10:00"},
			{ID: 2, FlowNo: "SYF202606180002", SiteID: 1, YardID: 1, PileID: 2, PileCode: "NS-YARD-STONE-01", MaterialID: 4, SourceType: "yard_level_report", Direction: "level_report", Quantity: 860, BalanceQty: 860, Unit: "t", MoistureRate: 1.2, QualityStatus: "passed", Actor: "device:YARD-NS-AGG", Remark: "网关堆场料位上报", CreatedAt: "2026-06-18 10:10:00"},
		},
		DispatchOrders: []DispatchOrder{
			{1, "DO202606180001", 1, 1, 1, 1, 1, 36, 36, 36, "A013", "2026-06-18 11:35:00", "completed", "", "2026-06-18 09:40:00", "2026-06-18 11:45:00", 1, 1, 1, "AC-13 沥青混合料"},
			{2, "DO202606180002", 1, 2, 2, 1, 1, 36, 36, 0, "A014", "2026-06-18 12:10:00", "in_transit", "", "2026-06-18 10:15:00", "2026-06-18 10:55:00", 1, 1, 1, "AC-13 沥青混合料"},
		},
		...
		DeliverySignLinks: []DeliverySignLink{
			{ID: 1, LinkNo: "SL202606180001", DispatchID: 1, TicketID: 1, OrderID: 1, LineID: 1, LineSeq: 1, ProductID: 1, ProductName: "AC-13 沥青混合料", CustomerID: 1, ProjectID: 1, Channel: "qr", Phone: "13800010001", Token: "seed-sign-token-used", URL: "/public/sign/seed-sign-token-used", QRCode: "qr://SL202606180001", Status: "used", SentAt: "2026-06-18 10:06:00", ExpiresAt: "2026-06-25 10:06:00", UsedAt: "2026-06-18 11:45:00", CreatedBy: "dispatcher", CreatedAt: "2026-06-18 10:06:00"},
		},
		TicketPrintLogs: []TicketPrintLog{
			{1, 1, "dispatcher", "2026-06-18 10:05:20"},
		},
		DeliverySigns: []DeliverySign{
			{ID: 1, SignNo: "DS202606180001", DispatchID: 1, LinkID: 1, TicketID: 1, OrderID: 1, LineID: 1, LineSeq: 1, ProductID: 1, ProductName: "AC-13 沥青混合料", CustomerID: 1, ProjectID: 1, Signer: "王经理", Phone: "13800010001", SignedQty: 36, Longitude: 113.9452, Latitude: 22.5358, Photo: "现场照片已归档", Signature: "电子签名已归档", Remark: "数量无异议", SignedAt: "2026-06-18 11:45:00"},
		},
		DeliverySignAttachments: []DeliverySignAttachment{
			{ID: 1, SignID: 1, DispatchID: 1, TicketID: 1, FileName: "site-delivery-20260618.jpg", FileType: "photo", URL: "data:image/jpeg;base64,c2VlZC1zaXRlLXBob3Rv", Checksum: "sha256:bbb05467b92dbfc615e448a2e2262c6c5e1416f80c9010f11203a2b1c74eb037", UploadedBy: "王经理", UploadedAt: "2026-06-18 11:45:10"},
		},
		Statements: []Statement{
			{1, "CS2026060001", 1, 1, "2026-06", 36, 18720, "财务-王维", "2026-06-18 13:20:00", "invoiced", []StatementItem{{1, 1, 1, 1, 1, 36, 520, 18720}}},
		},
		SalesInvoices: []SalesInvoice{
			{1, "INV202606180001", 1, 1, 18720, 0.13, 2433.6, "", "pending", "", "", "pending", "", "blue", "blue_vat_special", 0, 0, "", "", ""},
		},
		...
		Locations: []VehicleLocationEvent{
			...
			{3, 2, "粤B22336", 2, 0, "GPS1000002", "gps_device", 113.9346, 22.5433, 0, 0, 8561.3, 1, "online", "南山沥青站", false, "", "2026-06-18 11:03:00", "2026-06-18 11:03:01"},
		...
		GeoFences: []GeoFence{
			{ID: 1, Name: "南山沥青站围栏", Type: "site", SiteID: 1, Longitude: 113.9345, Latitude: 22.5431, Radius: 450, Shape: "circle", Status: "active"},
		...
		RuleDefinitions: []RuleDefinition{
			...
			{3, "asphalt_timeout_90m", "沥青 90 分钟未签收", "quality", "transport_minutes", ">", 90, "high", true, []string{"dispatcher", "quality"}, "沥青温控质量风险"},
		...
		IntegrationEndpoints: []IntegrationEndpoint{
			{1, "API Gateway", "gateway", "http", "/api", "online", "2026-06-18 11:00:00"},
			...
			{4, "沥青站接口 Gateway", "plant", "opc/rest", "plant://ns-amp240", "online", "2026-06-18 10:20:00"},
			{5, "财务税控接口", "finance", "rest", "", "standby", "2026-06-18 13:30:00"},
			{6, "催收短信通道", "collection", "sms", "", "standby", ""},
			{7, "催收企微通道", "collection", "wecom", "", "standby", ""},
		},
		...
		ApprovalFlows: []ApprovalFlow{
			...
			{2, "ticket_void", "过磅记录作废审批", "scale_ticket", []ApprovalStep{{1, "dispatcher", "approve"}, {2, "boss", "approve"}}, "active"},
		...
		DataDictionaries: defaultDataDictionaries(),
		...
		ProductRenewalInvoices: []ProductRenewalInvoice{
			{ID: 1, InvoiceNo: "RI202606190001", TaskID: 1, ContractID: 1, PaymentID: 1, InstanceID: 1, CustomerName: "湾区建材集团", LicenseID: "LIC-WQ-2026", Amount: 64000, TaxRate: 0.06, TaxAmount: 3840, InvoiceType: "blue_e_invoice", Status: "pending", TaxStatus: "pending", FileURL: "", CreatedBy: "财务-王维", CreatedAt: "2026-06-19 09:20:00", IssuedAt: "", ExternalRequest: "", Remark: "首期回款电子发票待税控配置后开具"},
		},
		ProductRenewalESigns: []ProductRenewalESign{
			{ID: 1, SignNo: "RS202606190001", TaskID: 1, ContractID: 1, InstanceID: 1, CustomerName: "湾区建材集团", LicenseID: "LIC-WQ-2026", Signer: "采购负责人-赵总", Phone: "13800019999", Channel: "local_esign", Status: "signed", SentBy: "客户成功-陈晨", SentAt: "2026-06-18 15:00:00", SignedAt: "2026-06-18 15:10:00", Signature: "FDD-CERT-RS202606190001", Remark: "年度续费合同电子签完成"},
		},
		ProductRenewalIntegrations: []ProductRenewalIntegration{
			{ID: 1, IntegrationNo: "RI202606190001", Name: "本地电子签网关", Code: "local_esign", Provider: "local", Scenario: "esign", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置真实电子签 endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-18 14:55:00", Remark: "生产部署需配置法大大、DocuSign 或客户自有电子签 endpoint 后启用"},
			{ID: 2, IntegrationNo: "RI202606190002", Name: "财务回款确认网关", Code: "finance_bank", Provider: "finance", Scenario: "payment", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置真实回款 endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-18 14:56:00", Remark: "生产部署需配置银行回单、财务系统或 ERP 收款确认 endpoint 后启用"},
			{ID: 3, IntegrationNo: "RI202606190003", Name: "税控电子发票网关", Code: "tax_gateway", Provider: "tax", Scenario: "tax", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置真实税控 endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-18 14:57:00", Remark: "生产部署需配置税控/电子发票平台 endpoint 后启用"},
		},
		ProductRenewalSyncRecords: []ProductRenewalSyncRecord{},
		ProductProbeReports: []ProductProbeReport{
			{ID: 1, ReportNo: "PR202606190001", InstanceID: 1, CustomerName: "湾区建材集团", Watermark: "CBMP-WQ-2026", Component: "server", ClientVersion: "1.0.1", ServerVersion: "1.0.1", Status: "healthy", CPUPercent: 38.2, MemoryPercent: 55.1, DiskPercent: 61.4, QueueBacklog: 12, ErrorCount: 0, Message: "现场运行正常", ReportedAt: "2026-06-19 08:30:00", ReceivedAt: "2026-06-19 08:30:02", SourceIP: "10.16.8.21"},
			{ID: 2, ReportNo: "PR202606190002", InstanceID: 2, CustomerName: "华南骨料运营中心", Watermark: "CBMP-HN-OPS", Component: "client", ClientVersion: "1.0.0", ServerVersion: "1.0.1", Status: "degraded", CPUPercent: 72.5, MemoryPercent: 68.2, DiskPercent: 84.9, QueueBacklog: 320, ErrorCount: 5, Message: "客户端版本落后且错误数升高", ReportedAt: "2026-06-19 08:10:00", ReceivedAt: "2026-06-19 08:10:03", SourceIP: "10.32.4.18", AlertRaised: true},
		},
		ProductTelemetryEvents: []ProductTelemetryEvent{
			{ID: 1, EventNo: "TE202606190001", InstanceID: 1, CustomerName: "湾区建材集团", Watermark: "CBMP-WQ-2026", Source: "apm", Component: "server", Severity: "warning", EventType: "slow_request", TraceID: "trace-wq-001", Endpoint: "/api/orders", DurationMs: 1850, StatusCode: 200, Message: "客户现场订单接口耗时升高", OccurredAt: "2026-06-19 08:32:00", ReceivedAt: "2026-06-19 08:32:02", SourceIP: "10.16.8.21", AlertRaised: true},
			{ID: 2, EventNo: "TE202606190002", InstanceID: 2, CustomerName: "华南骨料运营中心", Watermark: "CBMP-HN-OPS", Source: "log", Component: "client", Severity: "critical", EventType: "runtime_error", TraceID: "trace-hn-002", ErrorMessage: "客户端同步任务连续失败", Message: "客户端同步任务连续失败", OccurredAt: "2026-06-19 08:12:00", ReceivedAt: "2026-06-19 08:12:04", SourceIP: "10.32.4.18", AlertRaised: true},
		},
		ProductMonitoringIntegrations: []ProductMonitoringIntegration{
			{ID: 1, IntegrationNo: "MI202606190001", Name: "Prometheus 客户现场告警", Code: "prometheus-site", Provider: "prometheus", Status: "disabled", CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:00:00", Remark: "生产部署需配置 Alertmanager webhook token 后启用"},
		},
		ProductAlertRules: []ProductAlertRule{
			{ID: 1, RuleNo: "AR202606190001", Name: "CPU 使用率过高", Source: "prometheus", Component: "server", Metric: "cpu_percent", Operator: ">=", Threshold: 85, Severity: "critical", Status: "active", NotifyChannels: []string{"sse"}, CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:05:00", Remark: "客户现场服务端 CPU 持续高于阈值；配置外部通道后可追加 webhook"},
		...
		ProductAlertChannels: []ProductAlertChannel{
			...
			{ID: 2, ChannelNo: "AC202606190002", Name: "值班 Webhook", Code: "webhook", Type: "webhook", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置真实 webhook endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:01:00", Remark: "生产部署需配置企业微信、飞书或 ITSM webhook 后启用"},
			{ID: 3, ChannelNo: "AC202606190003", Name: "短信备用通道", Code: "sms", Type: "sms", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置真实短信 endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:02:00", Remark: "生产部署需配置短信网关 endpoint 后启用"},
			{ID: 4, ChannelNo: "AC202606190004", Name: "企业微信值班群", Code: "enterprise_wechat", Type: "enterprise_wechat", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 3, LastError: "待配置企业微信机器人 endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:03:00", Remark: "生产部署需配置企业微信机器人 endpoint、token 和 secret 后启用"},
			{ID: 5, ChannelNo: "AC202606190005", Name: "ITSM 工单通道", Code: "itsm", Type: "itsm", Status: "disabled", RetryLimit: 3, TimeoutSeconds: 5, LastError: "待配置 ITSM endpoint", CreatedBy: "平台管理员", CreatedAt: "2026-06-19 08:04:00", Remark: "生产部署需配置 ServiceNow、Jira 或 Zendesk endpoint 后启用"},
		},
		...
		AuditLogs: []AuditLog{{1, "system", "seed", "platform", 1, "初始化交付业务数据", "10.16.8.10", "2026-06-18 08:00:00"}},
	}

	data.WorkflowDefinitions = workflowDefinitionsFromApprovalFlows(data.ApprovalFlows)
