...
func TestBuildTrackReplayLinksStopsTicketsSignsAndFenceEvents(t *testing.T) {
	...
	data.Locations = append(data.Locations,
		VehicleLocationEvent{ID: 99, VehicleID: 1, PlateNo: "粤B12345", DriverID: 1, DispatchID: 1, DeviceID: "GPS1000001", SourceType: "gps_device", Longitude: 113.9368, Latitude: 22.5420, Speed: 18, Direction: 160, Mileage: 123450, AccStatus: 1, OnlineStatus: "online", Address: "南山混凝土站出入口", LocationTime: "2026-06-18 10:00:00", ReceiveTime: "2026-06-18 10:00:01"},
